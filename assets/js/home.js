...
const addTabContent = function ($currentTabBtn, $currentTabPanel) {
            ...
            <div class="card-body">
                ...
                <div class="meta-wrapper">
                    ...
                    <div class="meta-item">
                        ...
                        <span class="label-medium">${getTime(cookingTime)}</span>
                    </div>
...
for (const [index, $sliderSection] of $sliderSections.entries()) {
    $sliderSection.innerHTML = `
        <div class="container">
            <h2 class="sectioin-title headline-small" id="slider-label-${index + 1}">
